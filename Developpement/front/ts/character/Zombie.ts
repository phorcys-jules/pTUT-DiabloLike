...
export class Zombie extends Entity {
    ...
    constructor(name: string = 'michou', lvl: number = 1, speed: number = 100, strenth: number = 1, attackSpeed: number = 1, maxHp: number = 20, maxMp: number = 20, hp:number = 20, mp:number = 20, x: number = 64, y: number = 64) {
